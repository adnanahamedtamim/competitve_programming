...
ll func(string s, ll mid, ll x, ll seat) {  // finding maximum number of seated friends for a fixed amount of amibiverts being the first seater(introverts)
...
int main() {
    ...
    while (t--) {
        ...
        while (l < r) {  //unimodal , so we can apply bs here
            ll mid = (l + r) / 2;

            ll val = func(s, mid, x, se);
            ll val2 = func(s, mid + 1, x, se);
